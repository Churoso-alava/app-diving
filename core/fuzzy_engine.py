...
def construir_sistema_fuzzy():
    ...
    return vmp_v, acwr_v, delta_v, zmeso_v, ba_v, b28_v, wellness_v, ci_v, rpe_v, fat_v


def construir_sistema_fuzzy_legacy():
    """Compatibilidad retro con consumidores que esperan 6 elementos."""
    _vmp_v, acwr_v, delta_v, zmeso_v, ba_v, b28_v, _wellness_v, _ci_v, _rpe_v, fat_v = construir_sistema_fuzzy()
...
def construir_motor_fuzzy():
    ...
    # Desempaquetar los 10 elementos retornados por construir_sistema_fuzzy
